class Dustbin{
    constructor(x,y,width,height){
        ...
        this.bodyBottom=Bodies.rectangle(x+200,y-50,width,20,options);
    ...
    display(){
        ...
        rectMode(CENTER);
        fill("white");
        rect(0,posB.y+40,this.width,20);
        pop();
        ...
        rectMode(CENTER);
        fill("white");
        rect(posR.x-20,0,20,this.height);
        pop();
        ...
        rectMode(CENTER);
        fill("white");
        rect(posL.x+20,0,20,this.height);
        pop();
    }
}